...
// * Program Name: Lab03_B_While.java                 CS M10J (Intro Java)     *
// * Comment     : While Loop Program                 Intro to Prog using Java *
...
public class Lab03_B_While
{
	...
	public static void Header ()
	{
		...
		System.out.println("* Student Name: Mark Land                        " +
			"     Moorpark College         *");
		System.out.println("* Program Name: Lab03_B_While.java                 "
			+ "   CS M10J (Intro Java)     *");
		System.out.println("* Comment     : While Loop Program                 "
	...
	public static void Program ()
	{
		...
		if (number_1 < number_2)
		{
			...
			// checking, operation, output (continued):
			
			while (counter <= number_2)
			{
				while ((counter % 2 != 0)&&(counter <= number_2))
				{
		...
		System.out.printf("%nThe sum of the even numbers inclusively between %n"
			+ "%d and %d is: %d%n%n", number_1, number_2, sum);
	}
}
...
/*
Also, when I tested, -11 and 11, the sum of the even was: 12, I've no idea why
~how~where the cause of this is occuring, if it's from my code or Java's engine

Edit:

I found the reason, for the two most nested 'whiles', I also needed the check
of '&&(counter <= number_2)', as the higher layer check doesn't get run until
after the two most nested 'whiles', which allowed the two most nested 'whiles'
to run a last time over the max range of 'number_2'

here's what was my non-fixed code segment:
